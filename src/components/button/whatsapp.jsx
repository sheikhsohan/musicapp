    ...
    <>
      {showButton && (
        <div className={`fixed bottom-8 left-2 sm:left-1/2 sm:-translate-x-1/2 sm:bottom-12 md:bottom-16 lg:left-2 ${
          ...
          <button
            className="bg-accent/30 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-full flex items-center"
            onClick={handleClick}
          >
            <svg
            ...
            <span
              className="ml-2 text-pink-400 hover:text-gray-500 cursor-pointer"
